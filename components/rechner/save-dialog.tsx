    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-card border border-border rounded-lg shadow-xl">
        <div className="flex items-center justify-between px-4 py-3 border-b border-border">
          ...
          <button
            onClick={onCancel}
            className="p-1 rounded hover:bg-secondary transition-colors text-subtle hover:text-foreground"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="px-4 py-4">
          <div className="mb-3 text-[11px] text-subtle font-mono">
            Basierend auf {sourceUnitId}
          </div>

          <label className="block text-[11px] text-dimmed mb-1.5 font-mono tracking-wide">
            Beschreibung
          </label>
          <input
            ref={inputRef}
          ...
          <p className="mt-1.5 text-[10px] text-subtle font-mono">
            Name, Kunde, oder Szenario zur Unterscheidung
          </p>
        </div>
        ...
        <div className="flex gap-2 px-4 py-3 border-t border-border">
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1.5 py-2 px-3 rounded-md text-xs font-mono bg-primary text-primary-foreground border border-primary hover:bg-primary/90 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
          >
      ...
      <div className="relative w-full max-w-sm bg-card border border-border rounded-lg shadow-xl">
        <div className="px-4 py-4">
          ...
          <p className="text-xs text-dimmed font-mono">
            Du hast die Finanzierungsdaten ge\u00E4ndert. M\u00F6chtest du die Berechnung speichern?
          </p>
        </div>
        <div className="flex gap-2 px-4 py-3 border-t border-border">
          <button
            onClick={onDiscard}
            className="flex-1 py-2 px-3 rounded-md text-xs font-mono bg-secondary text-dimmed border border-border hover:text-destructive transition-all"
          >
            Verwerfen
          </button>
          <button
          ...
          <button
            onClick={onSave}
            className="flex-1 flex items-center justify-center gap-1.5 py-2 px-3 rounded-md text-xs font-mono bg-primary text-primary-foreground border border-primary hover:bg-primary/90 transition-all"
          >
            <Save className="w-3.5 h-3.5" />
            Speichern
          </button>
