...
export const SPANDAUER_TOR_BERATUNG: BeratungProjectData = {
  ...
  bigFive: {
    ...
    verwaltung: {
      score: 8,
      text: "Full-Service fuer Investoren: SE-Verwaltung uebernimmt Mieterwechsel + Neuvermietung. Untergemeinschaften je Haus.",
      criteria: [
        { label: "WEG-Struktur", score: 8, maxScore: 10, reasoning: "Untergemeinschaften je Haus (10 Haeuser). Entscheidungen koennen je Haus getroffen werden — kein 264-WE-Moloch bei Eigentuemerversammlungen. Investor hat Mitsprache im ueberschaubaren Rahmen." },
        { label: "SE-Verwaltung (Full-Service)", score: 9, maxScore: 10, reasoning: "SE-Verwaltung kuemmert sich um alles: Mieterwechsel, Neuvermietung, Mietinkasso, Nebenkostenabrechnung, Handwerkerkoordination. Der Investor muss sich um nichts kuemmern — genau das ist der Anspruch der Zielgruppe. WEG- und SE-Verwaltung sauber getrennt." },
        { label: "Kosten (Preis fuer Service)", score: 7, maxScore: 10, reasoning: "WEG ca. 26.50 EUR + SE ca. 30.00 EUR + Stellplatz 5.00 EUR = 61.50 EUR/Monat zzgl. USt. Das ist der Preis fuer Full-Service-Verwaltung. Aus Investorensicht relevant: Was bleibt netto uebrig? Die Kosten sind in der Musterberechnung bereits eingepreist." },
        { label: "Mietgarantie", score: 8, maxScore: 10, reasoning: "Verkaeuferin garantiert 21 EUR/m2 bis 31.03.2029. Bei Nichtbelegung wird Nettomiete fuer 1 Jahr gezahlt. Investor traegt in der Anfangsphase kein Leerstandsrisiko." },
      ],
      positives: ["SE-Verwaltung: Full-Service bei Mieterwechsel und Neuvermietung", "Investor muss sich um nichts kuemmern", "Untergemeinschaften je Haus — schlanke Entscheidungen", "Mietgarantie bis 2029 mit Leerstandsabsicherung"],
